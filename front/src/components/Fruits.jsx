...
const Fruits = () => {
  ...
  const FruitsProducts = productsToShow.filter(
    (item) => item.category === "Fruits & Vegetables"
  );
  // Group products by subcategory
  const groupedBySubcategory = FruitsProducts.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-2 sm:px-4">
      <div className="mb-8 text-center">
        <h3 className="text-3xl font-extrabold text-green-700 tracking-tight">Fruits & Vegetables</h3>
      </div>
