...
const Oil = () => {
  ...
  const OilProducts = productsToShow.filter(
    (item) => item.category === "Masala, Oil & More"
  );
  // Group products by subcategory
  const groupedBySubcategory = OilProducts.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-2 sm:px-4">
      <div className="mb-8 text-center">
        <h3 className="text-3xl font-extrabold text-green-700 tracking-tight">Masala, Oil & More</h3>
      </div>
