...
const Tea = () => {
  ...
  const TeaProducts = productsToShow.filter(
    (item) => item.category === "Tea, Coffee & Health Drink"
  );
  // Group products by subcategory
  const groupedBySubcategory = TeaProducts.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-2 sm:px-4">
      <div className="mb-8 text-center">
        <h3 className="text-3xl font-extrabold text-green-700 tracking-tight">Tea, Coffee & Health Drink</h3>
      </div>
