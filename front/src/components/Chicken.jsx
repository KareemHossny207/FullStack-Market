...
const Chicken = () => {
  ...
  const ChickenProducts = productsToShow.filter(
    (item) => item.category === "Chicken, Meat & Fish"
  );

  const groupedBySubcategory = ChickenProducts.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-2 sm:px-4">
      <div className="mb-8 text-center">
        <h3 className="text-3xl font-extrabold text-green-700 tracking-tight">Chicken, Meat & Fish</h3>
      </div>
