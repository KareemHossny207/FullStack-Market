...
const Cleaning = () => {
  ...
  const CleaningProducts = productsToShow.filter(
    (item) => item.category === "Cleaning Essentials"
  );

  const groupedBySubcategory = CleaningProducts.reduce((acc, item) => {
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-2 sm:px-4">
      <div className="mb-8 text-center">
        <h3 className="text-3xl font-extrabold text-green-700 tracking-tight">Cleaning Essentials</h3>
      </div>
